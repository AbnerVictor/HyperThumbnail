...
def main():
    ...
    opt['input_folder'] = 'datasets/Image_Super_Resolution/Classic/DIV2K/HR/DIV2K_train_HR'
    opt['save_folder'] = 'datasets/Image_Super_Resolution/Classic/DIV2K/HR/DIV2K_train_HR_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    opt['save_folder'] = 'datasets/Image_Super_Resolution/Classic/DIV2K/LR/DIV2K_train_LR_bicubic/X4_sub'
    opt['crop_size'] = 120
    opt['step'] = 60
    opt['thresh_size'] = 0
    extract_subimages(opt)

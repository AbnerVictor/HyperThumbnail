...
def main():
    ...
    opt['input_folder'] = workspace_path+'datasets/Image_Super_Resolution/Classic/Set5/LRbicx4'
    opt['save_folder']  = workspace_path+'datasets/Image_Super_Resolution/Classic/Set5/LRbicx4_JPEG'
    opt['crop_size'] = None
    opt['step'] = 100000
    opt['thresh_size'] = -1
    extract_subimages(opt)

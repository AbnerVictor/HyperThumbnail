...
def main():
    ...
    # /home/chenyangqi/disk1/fast_rescaling/Video-Enhancement-Playground/datasets/Image_Super_Resolution/Classic/DIV2K/LR/DIV2K_train_LR_CAR/X4_sub
    opt['save_folder']  = workspace_path+'datasets/Image_Super_Resolution/Classic/DIV2K/LR/DIV2K_train_LR_CAR/X4_sub'
    opt['crop_size'] = 120
    opt['step'] = 60
    opt['thresh_size'] = 0
    extract_subimages(opt)
...
def worker(path, opt):
    ...
    for x in h_space:
        for y in w_space:
            ...
            cv2.imwrite(
                osp.join(opt['save_folder'], f'{img_name}_s{index:03d}.jpg'), cropped_img,

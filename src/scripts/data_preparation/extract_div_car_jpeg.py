...
def main():
    ...
    input_folder_list = ['/home/chenyangqi/disk1/fast_rescaling/Video-Enhancement-Playground/datasets/Image_Super_Resolution/Classic/Set5/LRbicx4_CAR',
    '/home/chenyangqi/disk1/fast_rescaling/Video-Enhancement-Playground/datasets/Image_Super_Resolution/Classic/Set14/LRbicx4_CAR',
    '/home/chenyangqi/disk1/fast_rescaling/Video-Enhancement-Playground/datasets/Image_Super_Resolution/Classic/BSDS100/LR/bicubic_4x_CAR',
    '/home/chenyangqi/disk1/fast_rescaling/Video-Enhancement-Playground/datasets/Image_Super_Resolution/Classic/urban100/LR/bicubic_4x_CAR',
    '/home/chenyangqi/disk1/fast_rescaling/Video-Enhancement-Playground/datasets/Image_Super_Resolution/Classic/DIV2K/LR/DIV2K_valid_LR_CAR']
    for input_folder in input_folder_list:
        ...
        opt['save_folder']  = opt['input_folder']+'_JPEG'
...
def worker(path, opt):
    ...
    assert '_down' in img_name
    img_name = img_name.replace('x2', '').replace('x3', '').replace('x4', '').replace('x8', '').replace('_down', '')
